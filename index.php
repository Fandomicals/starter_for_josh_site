      ...
      <section class="container-fluid articlebg">
        <div class="container">
            <div class="row"><!--  a row that gives us access to the BS columns-->
                ...
                <div class="col-md-4">
                    <img class="img-responsive" alt=“portrait” src="http://206.189.45.97/~mesh22/sub3/wp-content/themes/starter_for_josh_site/images/img1.jpg">
                    <h4>A PORTRAIT</h4>
                ...
                <div class="col-md-4">
                    <img class="img-responsive" alt=“portrait” src="http://206.189.45.97/~mesh22/sub3/wp-content/themes/starter_for_josh_site/images/img2.jpg">
                    <h4>A PORTRAIT</h4>
                    <p class="date">12 December 2020</p>
                    <p>STS has never been shy of seeking new terrains of investigation. More and more STS s cholars are starting to explore and intervene in the arts. This object of study brings new challenges and opportunities that we want to explore in this session. We would like to gather first of all simply new kinds of knowledge arising from STS study of the arts.
                    </p>
                ...
                <div class="col-md-4">
                    <img class="img-responsive" alt=“portrait” src="http://206.189.45.97/~mesh22/sub3/wp-content/themes/starter_for_josh_site/images/img3.jpg">
                    <h4>A PORTRAIT</h4>
                    <p class="date">12 December 2020</p>
                    <p>STS has never been shy of seeking new terrains of investigation. More and more STS s cholars are starting to explore and intervene in the arts. This object of study brings new challenges and opportunities that we want to explore in this session. We would like to gather first of all simply new kinds of knowledge arising from STS study of the arts.
                    </p>
